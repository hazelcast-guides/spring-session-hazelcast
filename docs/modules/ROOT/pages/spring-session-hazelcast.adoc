...
:sourcedir: {examplesdir}/src/main/java
...
[source, java]
----
include::{sourcedir}/com/hazelcast/guide/config/SessionConfiguration.java[tags=hazelcastInstance]
----
--
...
[source, java]
----
include::{sourcedir}/com/hazelcast/guide/config/SessionConfiguration.java[tags=hazelcastClient]
----
...
[source, java]
----
include::{sourcedir}/com/hazelcast/guide/config/SessionConfiguration.java[tags=customization]
----
--
